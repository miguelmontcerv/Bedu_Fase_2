...
#1 filas, 2 columnas
apply(n, 1, mean) #Calcula el promedio por cada fila
apply(n, 2, mean)#Calcula el promedio por cada columna
apply(n, 2, sort) #Ordena por columnas
